  ...
  training.cols0 = training.cols1[-highlyCorDescr]
  ...
  model0
  save(model0, file="model1.rda")    
  
  model1.predict <- predict(model0, newdata = X.test)
  table(model0.predict)
  model0.e <- sqrt(mean((log(model0.predict) - log(y.test))^2))